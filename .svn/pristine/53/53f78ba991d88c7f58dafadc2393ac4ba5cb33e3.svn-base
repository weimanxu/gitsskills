...
class Image
{
    ...
    // 图片优化缩略方法
    public function resizeImage($src_file, $savePath) 
    {
        ...
        if (($ratio_w < 1 && $ratio_h < 1) || ($ratio_w > 1 && $ratio_h > 1)) 
        {
            ...
            $_rtn = self::saveImage($new_img, $this->shrink_type, $savePath, substr($this->saveName,0,-4));
    ...
    function showErrmsg()
    {
        ...
        return iconv('GBK', 'UTF-8', $this->erro_msg);
        //return  mb_convert_encoding($this->erro_msg, "UTF-8", "GBK");
